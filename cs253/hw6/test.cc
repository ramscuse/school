...
//  New Test Cases
    ...
    /* more new tests
    Schedule s3;
    s3 += Show("Bull", "CBS", 21*4, 4, true);
    s3 += Show("Young Sheldon", "CBS", 19*4, 2);
    s3 += Show("How We Roll", "CBS", 20*4+2, 2);
    s3 += Show("Law & Order: Organized Crime", "NBC", 21*4, 4, true);
    s3 += Show("United States of Al", "CBS", 19*4+2, 2);
    s3 += Show("Law & Order", "NBC", 19*4, 4, true);
    s3 += Show("Ghosts", "CBS", 20*4, 2, false);
    s3 += Show("Law & Order: SVU", "NBC", 20*4, 4, true);
